...
class MusicRandomScreenOneScreen extends StatelessWidget {
  @override
                                                                        ...
                                                                        Align(
                                                                            ...
                                                                            child: Container(
                                                                                ...
                                                                                child: Stack(alignment: Alignment.bottomRight, children: [
                                                                                  CustomImageView(imagePath: ImageConstant.imgDice, height: getSize(130), width: getSize(130), alignment: Alignment.topLeft),
                                                                                  Align(alignment: Alignment.bottomRight, child: Container(height: getVerticalSize(92), width: getHorizontalSize(72), margin: getMargin(right: 28), decoration: BoxDecoration(color: ColorConstant.blue30033, borderRadius: BorderRadius.circular(getHorizontalSize(8))))),
                                                                                  CustomImageView(imagePath: ImageConstant.imgDice85x100, height: getVerticalSize(85), width: getHorizontalSize(100), alignment: Alignment.bottomRight)
                                                                                ])))
                                                                      ])))
                                                        ])))
                                          ]))),
