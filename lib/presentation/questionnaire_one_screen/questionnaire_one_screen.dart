...
class QuestionnaireOneScreen extends StatelessWidget {
  @override
                      ...
                      Expanded(
                          child: SingleChildScrollView(
                            ...
                            CustomButton(
                                text: "Be happier",
                                margin:
                                    getMargin(left: 48, top: 12, right: 48)),
                            Container(
                                width: getHorizontalSize(330),
  ...
  onTapNext(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.homeScreenLandingContainerScreen);
  }
}
